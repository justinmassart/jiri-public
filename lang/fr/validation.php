...
return [
    ...
    */
    ...
    'password' => [
        ...
        'uncompromised' => 'Le mot de passe fourni est apparu dans une fuite de données. Veuillez choisir un mot de passe différent.',
    ],
    ...
    */
    ...
    'custom' => [
        ...
        'email' => [
            'exists' => 'Cette adresse email n’existe pas dans notre base de données.',
